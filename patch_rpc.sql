...
AS $$
    WITH base AS (
        SELECT
            ...
            CASE
                ...
                ELSE (
                    ...
                    + similarity(COALESCE(a.city, ''), p_q)
                    + similarity(COALESCE(a.wilaya, ''), p_q)
        ...
        WHERE (p_wilaya_code IS NULL OR a.wilaya_code = p_wilaya_code)
          ...
          AND (
                ...
                OR COALESCE(a.city, '') ILIKE '%' || p_q || '%'
                OR COALESCE(a.wilaya, '') ILIKE '%' || p_q || '%'
